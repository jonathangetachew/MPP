...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(LambdaLibrary2.EMPLOYEE_NAMES_MIN_SALARY_LAST_NAME_START_WITH_AFTER.apply(list, 100000F, 'E'));
		...
		System.out.println(LambdaLibrary2.EMPLOYEE_NAMES_MIN_SALARY_FIRST_NAME_START_WITH_BEFORE.apply(list, 85000F, 'R'));
